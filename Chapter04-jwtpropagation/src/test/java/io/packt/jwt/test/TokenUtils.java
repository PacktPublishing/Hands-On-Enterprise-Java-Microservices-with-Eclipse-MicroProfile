...
public class TokenUtils {
    ...
    /**
     * Utility method to generate a JWT string from a JSON resource file that is signed by the private-key.pem
    ...
    public static String generateTokenString(String jsonResName, Map<String, Long> timeClaims)
        ...
        PrivateKey pk = readPrivateKey("/private-key.pem");
        return generateTokenString(pk, "/private-key.pem", jsonResName, timeClaims);
    }
